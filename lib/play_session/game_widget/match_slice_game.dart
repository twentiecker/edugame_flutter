                          ...
                          Draggable(
                            ...
                            feedback: Container(
                              ...
                              child: widget.isColor
                                  ? Image.asset(
                                      'assets/images/${widget.category}/${domain[index]['image']!}.png',
                                      scale: scale,
                                      color: colors[
                                  ...
                                  : widget.isSymmetric
                                      ? Image.asset(
                                          'assets/images/${widget.category}/${domain[index]['image']!}.png')
                                      : Image.asset(
                                          'assets/images/${widget.category}/${domain[index]['image']!}_01.png'),
                            ),
                        ...
                        children: [
                          DragTarget(builder: (
                            ...
                            return Container(
                              ...
                              child: isTrue[index]
                                  ? widget.isColor
                                      ? Image.asset(
                                          'assets/images/${widget.category}/${codomain[index]['image']!}.png',
                                          scale: scale,
                                      ...
                                      : widget.isSymmetric
                                          ? Image.asset(
                                              'assets/images/${widget.category}/${codomain[index]['image']!}.png')
                                          : Image.asset(
                                              'assets/images/${widget.category}/${codomain[index]['image']!}_01.png')
                                  : Container(
                                      height: height,
                                      width: width,
                                      color: Colors.white,
                            ...
                            if (details.data['data'] ==
                                codomain[index]['data']) {
                              flutterTts.speak('${details.data['image']}');
                              setState(() {
                                isTrue[index] = true;
                              });
                              winGame();
                          ...
                          Container(
                            ...
                            child: widget.isSymmetric
                                ...
                                : Image.asset(
                                    'assets/images/${widget.category}/${codomain[index]['image']!}_02.png'),
                          )
                        ],
                      )
                    ],
